      ...
      <Container>
        <Grid container
          ...
          <Box sx={{ width: '80%', height: '70vh', border: '1px solid red', overflowY: 'auto' }}>
            {
              messages.sort((a, b) => a.createDate - b.createDate).filter(obj => obj.imgUrl !== 'https://e7.pngegg.com/pngimages/349/288/png-clipart-teacher-education-student-course-school-avatar-child-face.png').map(obj => {
                return <div
